...
/*
 * INPUT FORMAT: first number of instructions, then pseudocode for each
 * instruction in a new line. then the number of memory elements needed to
 * specify, then the memory contents in the following lines
 */
