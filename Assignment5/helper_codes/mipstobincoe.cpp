...
/*
 * INPUT FORMAT: Firstly number of instructions, then all instructions in different lines
 * 				 Then the number of memory elements that need to be initialised, and each memory element on a new line
 */
...
//syntax for command - remove all $ and commas, and then replace brackets by spaces
